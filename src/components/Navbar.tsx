  ...
  return (
    ...
    >
      <div ref={menuRef} className="flex items-center justify-between ">
        ...
        <div
          className={`md-hidden text-gray-200 absolute w-2/3 h-screen px-1 py-2 font-medium  bg-black top-0 duration-500 ${
            menuOpen ? "right-0" : "right-[-100%]"
          }`}
        >
          <ul className="flex flex-col justify-center h-full gap-9 py-2 text-lg">
            {menuLinks.map((menu) => (
              <li
              ...
              >
                <a href={menu.link} className="flex flex-row gap-3">
                  {menu.logo} {menu.name}
                </a>
              </li>
            ))}
